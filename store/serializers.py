...
from store.models import OutdoorImage, OutdoorColor
from store.models import CancelledOrder, Cart, CartOrderItem, Notification, CouponUsers, Product, Tag ,Category, DeliveryCouriers, CartOrder, Gallery, Brand, ProductFaq, Review,  Specification, Coupon, Color, Size, Address, Wishlist, Vendor, CartOrder, MobileImage
...
class OutdoorImageSerializer(serializers.ModelSerializer):
    class Meta:
        model = OutdoorImage
        fields = '__all__'

class OutdoorColorSerializer(serializers.ModelSerializer):
    class Meta:
        model = OutdoorColor
        fields = '__all__'
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    OutdoorImage = OutdoorImageSerializer(many=True, read_only=True)
    OutdoorColor = OutdoorColorSerializer(many=True, read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'OutdoorImage',
            'OutdoorColor',
            'product_color',  # Add product_color
            'product_size',   # Add product_size
            'mobile_images',  # Add mobile_images
        ]
