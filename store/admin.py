...
from store.models import CartOrderItem, CouponUsers, Notification, Product, Tag ,Category, Cart, DeliveryCouriers, CartOrder, Gallery, Brand, ProductFaq, Review,  Specification, Coupon, Color, Size, Address, Wishlist,OutdoorImage, OutdoorColor, MobileImage
...
class OutdoorImageAdmin(admin.TabularInline):
    model = OutdoorImage

class OutdoorColorAdmin(admin.TabularInline):
    model = OutdoorColor
...
class ProductAdmin(ImportExportModelAdmin):
    inlines = [ProductImagesAdmin, SpecificationAdmin, ColorAdmin, SizeAdmin, OutdoorImageAdmin, OutdoorColorAdmin, MobileImageInline]
