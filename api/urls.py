...
urlpatterns = [
    ...
    path('update-cart-quantity/', store_views.UpdateCartQuantityView.as_view(), name='update-cart-quantity'),
    ...
    path('razorpay-checkout/<str:order_oid>/', store_views.RazorpayCheckoutView.as_view(), name='razorpay-checkout'),
    path('payment-success/', store_views.PaymentSuccessView.as_view(), name='payment-success'),
    # path('invoice/<int:invoice_id>/', store_views.InvoiceDetailView.as_view(), name='invoice-detail'),
