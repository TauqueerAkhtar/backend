...
class ConfigSettings(models.Model):
    ...
    service_fee_percentage = models.IntegerField(default=0, help_text="NOTE: Numbers added here are in percentage (%) e.g 0%")
    service_fee_flat_rate = models.DecimalField(default=0.0, max_digits=12, decimal_places=2, help_text="NOTE: Add the amount you want to charge as service fee e.g 0.00")
...
class Tax(models.Model):
    ...
    rate = models.IntegerField(default=12, help_text="Numbers added here are in percentage (12 = 12%)")
